...
score.innerText=localStorage.getItem("score")||0,localStorage.setItem('amiens/mairie', true), checkCity.addEventListener("click",function() {
    if(cityInput.value) {
...
checkPlace.addEventListener("click",async function() {
    if(placeInput.value) {
        ...
        if(t)try {
            ...
            `);
            if(Math.abs(c.lat-o.lat)<.001&&Math.abs(c.lng-o.lng)<.001&&!localStorage.getItem(`$ {
                t
            }
            /$ {
                n
